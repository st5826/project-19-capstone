var fish, fishIMG, deadFish, shark, sharkIMG
...
deadFish=loadImage("dead fish.png")
    ...
    function spawnCorals(){
        ...
        function spawnAnimals(){
          ...
          function spawnSeaweeds(){
            if(frameCount%235==0){
              seaweed=createSprite(820,253,20,20)
              ...
              seaweed.depth=coral.depth
              seaweed.depth=seaweed.depth+5
            }
            }
